/*
In this example you can see what can be called a “
boomerang effect” of callback chaining, where
the text indentation increases and then
 decreases along with function nesting.
 */
var fs = require('fs');
